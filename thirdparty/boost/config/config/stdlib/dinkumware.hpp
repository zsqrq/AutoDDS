...
#ifndef AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_STDLIB_DINKUMWARE_HPP_
#define AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_STDLIB_DINKUMWARE_HPP_
...
#include "boost/config/config/no_tr1/utility.hpp"
#if !defined(_YVALS) && !defined(_CPPLIB_VER)
...
#endif //AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_STDLIB_DINKUMWARE_HPP_