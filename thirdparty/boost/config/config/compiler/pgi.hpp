...
#ifndef AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_COMPILER_PGI_HPP_
#define AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_COMPILER_PGI_HPP_
...
#endif //AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_COMPILER_PGI_HPP_