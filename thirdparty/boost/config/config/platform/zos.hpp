...
#ifndef AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_PLATFORM_ZOS_HPP_
#define AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_PLATFORM_ZOS_HPP_
...
#endif //AUTODDS_THIRDPARTY_BOOST_CONFIG_CONFIG_PLATFORM_ZOS_HPP_