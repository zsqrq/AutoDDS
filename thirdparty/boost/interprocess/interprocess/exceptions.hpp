...
//
//////////////////////////////////////////////////////////////////////////////
#ifndef AUTODDS_THIRDPARTY_BOOST_INTERPROCESS_INTERPROCESS_EXCEPTIONS_HPP_
#define AUTODDS_THIRDPARTY_BOOST_INTERPROCESS_INTERPROCESS_EXCEPTIONS_HPP_
...
#pragma once
#endif
#include <boost/interprocess/interprocess/detail/workaround.hpp>
#include <boost/interprocess/interprocess/errors.hpp>
#include <stdexcept>
#include "boost/interprocess/interprocess/detail/config_begin.hpp"
...
class BOOST_SYMBOL_VISIBLE interprocess_exception : public std::exception {
 public:
  interprocess_exception(const char *err) BOOST_NOEXCEPT
      : m_err(other_error){BOOST_TRY{m_str = err;
} BOOST_CATCH(...) {
}
BOOST_CATCH_END
}  // namespace interprocess
...
native_error_t get_native_error() const BOOST_NOEXCEPT {
  return m_err.get_native_error();
}

// Note: a value of other_error implies a library (rather than system) error
error_code_t get_error_code() const BOOST_NOEXCEPT {
...
#include "boost/interprocess/interprocess/detail/config_end.hpp"

#endif  // AUTODDS_THIRDPARTY_BOOST_INTERPROCESS_INTERPROCESS_EXCEPTIONS_HPP_