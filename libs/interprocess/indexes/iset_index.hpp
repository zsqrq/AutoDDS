...
#ifndef AUTODDS_LIBS_INTERPROCESS_INDEXES_ISET_INDEX_HPP_
#define AUTODDS_LIBS_INTERPROCESS_INDEXES_ISET_INDEX_HPP_
...
struct iset_index_aux
{
  ...
  typedef typename bi::make_set_base_hook<
      ...
      bi::optimize_size<true>>::type                        derivation_hook;

  typedef typename MapConfig::template intrusive_value_type<
      derivation_hook>::type                                value_type;
  typedef typename std::less<value_type>                    value_compare;
  typedef typename bi::make_set
      <value_type, bi::base_hook<derivation_hook>>::type    index_t;
};

template <class MapConfig>
class iset_index : public iset_index_aux<MapConfig>::index_t
{
...
template<class MapConfig>
struct is_intrusive_index<autodds::libs::interprocess::iset_index<MapConfig> >
{
...
#endif //AUTODDS_LIBS_INTERPROCESS_INDEXES_ISET_INDEX_HPP_